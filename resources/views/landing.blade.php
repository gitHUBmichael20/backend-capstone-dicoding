...
<head>
    ...
    <title>Welcum To Pinjam Satoe</title>
...
<body>
    ...
    <section
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">"PALUGADA" Apa lu mau gw ada. Pinjam apapun disini</h1>
